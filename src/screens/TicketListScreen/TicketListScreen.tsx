...
import { useStyles } from "./TicketListScreen.styles";
...
const TicketListScreen: React.FC = () => {
  ...
  return (
    <Box className={classes.container}>
      ...
      <Box className={classes.pageTitle}>{lang.listTicket.view.header}</Box>
        ...
        <Box className={classes.filterBar}>
          ...
          <Box className={classes.filterGroup} style={{ flex: 1 }}>
            <Box component="label" htmlFor="keyword">
              {lang.listTicket.view.keyword}
            </Box>
            <Box display="flex" alignItems="center" gap={1}>
              <TextField
                id="keyword"
                placeholder="Mã Ticket, Khách hàng..."
                size="small"
                variant="outlined"
                value={keyword}
      ...
      <Box className={classes.viewBtnAction}>
        <Box className={classes.exportImportBar}>
          <Box className={classes.txtMassAssign}>
            {lang.listTicket.view.allaction}:
          </Box>
          <Box className={classes.btnMassAssign}>
            {lang.listTicket.view.bulkbrosing}
          </Box>
          <Box className={classes.btnMassAssign}>
            {lang.listTicket.view.uploadList}
          </Box>
        </Box>
